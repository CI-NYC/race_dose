...
for (i in 3:4) 
{
    data_met_binomial_lim <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met_limited", j, sep = "_", i, ".rds")))
    ...
    data_met_binomial_all <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met", j, sep = "_", i, ".rds")))
    ...
    data_bup_binomial_lim <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result_limited", j, sep = "_", i, ".rds")))
    ...
    data_bup_binomial_all <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result", j, sep = "_", i, ".rds")))
    ...
    data_comb_binomial_lim <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb_limited", j, sep = "_", i, ".rds")))
    ...
    data_comb_binomial_all <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb", j, sep = "_", i, ".rds")))
...
for (i in 1:4) {
    ...
    bup_binomial_as_1[[i-2]] <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result_limited", "1", sep = "_", i, ".rds")))
    
    bup_binomial_as_2[[i-2]] <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result_limited", "2", sep = "_", i, ".rds")))
    
    bup_binomial_as_3[[i-2]] <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result_limited", "3", sep = "_", i, ".rds")))
    
    #met binomial limited
    met_binomial_as_1[[i-2]] <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met_limited", "1", sep = "_", i, ".rds")))
    
    met_binomial_as_2[[i-2]] <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met_limited", "2", sep = "_", i, ".rds")))
    
    met_binomial_as_3[[i-2]] <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met_limited", "3", sep = "_", i, ".rds")))
    
    # bup binomial all
    bup_binomial_1[[i-2]] <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result", "1", sep = "_", i, ".rds")))

    bup_binomial_2[[i-2]] <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result", "2", sep = "_", i, ".rds")))
    
    bup_binomial_3[[i-2]] <- readRDS(here::here(paste0("./data/102623/bup_binomial/","result", "3", sep = "_", i, ".rds")))

    # met binomial all
    met_binomial_1[[i-2]] <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met", "1", sep = "_", i, ".rds")))
    met_binomial_2[[i-2]] <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met", "2", sep = "_", i, ".rds")))
    met_binomial_3[[i-2]] <- readRDS(here::here(paste0("./data/102623/met_binomial/","result_met", "3", sep = "_", i, ".rds")))
    
    #comb binomial limited
    comb_binomial_as_1[[i-2]] <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb_limited", "1", sep = "_", i, ".rds")))
    
    comb_binomial_as_2[[i-2]] <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb_limited", "2", sep = "_", i, ".rds")))
    
    comb_binomial_as_3[[i-2]] <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb_limited", "3", sep = "_", i, ".rds")))
    
    # comb binomial all
    comb_binomial_1[[i-2]] <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb", "1", sep = "_", i, ".rds")))
    comb_binomial_2[[i-2]] <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb", "2", sep = "_", i, ".rds")))
    comb_binomial_3[[i-2]] <- readRDS(here::here(paste0("./data/102623/comb_binomial/","result_comb", "3", sep = "_", i, ".rds")))
    }
}
...
met_cont_lim <- met_results_lim |>
    mutate(type = "Age + Sex")

met_cont_all <- met_results_all |>
...
met_cont_plot <- ggplot(met_cont_total, aes(x = week, y = theta, group = race, color = race, fill = race, shape = race)) +
    ...
    theme(
        ...
        legend.margin = margin(-12, 1.5, 1.5, 1.5),
...
met_cont_plot_final <- met_cont_plot + met_pairwise + 
    plot_annotation(tag_levels = 'A') + plot_layout(ncol = 1) & 
    theme(plot.tag = element_text(size = 12),
          panel.border = element_rect(colour = "black", fill=NA, size = 1))

ggsave(filename = here::here("figures/met_cont_plot_final.png"),
       plot = met_cont_plot_final,
       width = 8, height = 11)

bup_cont_unadj <- data_bup_long |>
    mutate(type = "Unadjusted")

bup_cont_lim <- bup_results_lim |>
    mutate(type = "Age + Sex")

bup_cont_all <- bup_results_all |>
    mutate(type = "Expanded")
...
bup_cont_plot_final <- bup_cont_plot + bup_pairwise + 
    plot_annotation(tag_levels = 'A') + plot_layout(ncol = 1) & 
    theme(plot.tag = element_text(size = 12),
          panel.border = element_rect(colour = "black", fill=NA))

ggsave(filename = here::here("figures/bup_cont_plot_final.png"),
       plot = bup_cont_plot_final,
       width = 8, height = 11)
```
...
met_binomial_plot_final <- met_binomial_plot + met_binomial_pairwise + 
    plot_annotation(tag_levels = 'A') + plot_layout(ncol = 1) & 
    theme(plot.tag = element_text(size = 12),
          panel.border = element_rect(colour = "black", fill=NA))

ggsave(filename = here::here("figures/met_binomial_plot_final.png"),
       plot = met_binomial_plot_final,
       width = 8, height = 11)
...
bup_binomial_plot_final <- bup_binomial_plot + bup_binomial_pairwise + 
    plot_annotation(tag_levels = 'A') + plot_layout(ncol = 1) & 
    theme(plot.tag = element_text(size = 12),
          panel.border = element_rect(colour = "black", fill=NA))

ggsave(filename = here::here("figures/bup_binomial_plot_final.png"),
       plot = bup_binomial_plot_final,
       width = 8, height = 11)
```
...
comb_binomial_plot_final <- comb_binomial_plot + comb_binomial_pairwise + 
    plot_annotation(tag_levels = 'A') + plot_layout(ncol = 1) & 
    theme(plot.tag = element_text(size = 12),
          panel.border = element_rect(colour = "black", fill=NA))

ggsave(filename = here::here("figures/comb_binomial_plot_final.png"),
       plot = comb_binomial_plot_final,
       width = 8, height = 11)
```
