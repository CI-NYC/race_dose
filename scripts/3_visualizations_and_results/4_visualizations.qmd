...
for (i in 1:4) {
    ...
    if (i > 2)
    {
  data_met <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met", j, sep = "_", i, ".rds")))
  ...
  data_met_lim <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met_limited", j, sep = "_", i, ".rds")))
  ...
  data_bup <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor", j, sep = "_", i, ".rds")))
  ...
  data_bup_lim <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor_limited", j, sep = "_", i, ".rds")))
  ...
  data_bup <- readRDS(here::here(paste0("./data/final_0724/bup/","result", j, sep = "_", i, ".rds")))
  bup_result_newcensors_all_temp[[i, "week"]] <- i
  bup_result_newcensors_all_temp[[i, "race"]] <- j
  bup_result_newcensors_all_temp[[i, "theta"]] <- data_bup$theta
  bup_result_newcensors_all_temp[[i, "se"]] <- data_bup$standard_error
  ...
  data_bup_lim <- readRDS(here::here(paste0("./data/final_0724/bup/","result_limited", j, sep = "_", i, ".rds")))
  bup_result_newcensors_lim_temp[[i, "week"]] <- i
  bup_result_newcensors_lim_temp[[i, "race"]] <- j
  bup_result_newcensors_lim_temp[[i, "theta"]] <- data_bup_lim$theta
  bup_result_newcensors_lim_temp[[i, "se"]] <- data_bup_lim$standard_error
...
for (i in 3:4) 
{
    data_comb_binomial_lim <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb_limited", j, sep = "_", i, ".rds")))
    ...
    data_comb_binomial_all <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb", j, sep = "_", i, ".rds")))
...
for (i in 1:4) {
    ...
    #bup limited
    bup_as_1[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor_limited", "1", sep = "_", i, ".rds")))
    
    bup_as_2[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor_limited", "2", sep = "_", i, ".rds")))
    
    bup_as_3[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor_limited", "3", sep = "_", i, ".rds")))

    #met limited
    met_as_1[[i]] <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met_limited", "1", sep = "_", i, ".rds")))
    
    met_as_2[[i]] <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met_limited", "2", sep = "_", i, ".rds")))

    met_as_3[[i]] <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met_limited", "3", sep = "_", i, ".rds")))
    
    # bup all
    bup_1[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor", "1", sep = "_", i, ".rds")))

    bup_2[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor", "2", sep = "_", i, ".rds")))
    
    bup_3[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_newcensor", "3", sep = "_", i, ".rds")))

    # met all
    met_1[[i]] <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met", "1", sep = "_", i, ".rds")))
    met_2[[i]] <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met", "2", sep = "_", i, ".rds")))
    met_3[[i]] <- readRDS(here::here(paste0("./data/final_0724/met/","result_newcensor_met", "3", sep = "_", i, ".rds")))
    
    # binomial
    
    #comb binomial limited
    comb_binomial_as_1[[i-2]] <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb_limited", "1", sep = "_", i, ".rds")))
    
    comb_binomial_as_2[[i-2]] <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb_limited", "2", sep = "_", i, ".rds")))
    
    comb_binomial_as_3[[i-2]] <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb_limited", "3", sep = "_", i, ".rds")))
    
    # comb binomial all
    comb_binomial_1[[i-2]] <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb", "1", sep = "_", i, ".rds")))
    comb_binomial_2[[i-2]] <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb", "2", sep = "_", i, ".rds")))
    comb_binomial_3[[i-2]] <- readRDS(here::here(paste0("./data/final_0724/comb_binomial/","result_newcensor_comb", "3", sep = "_", i, ".rds")))
    } else
    {
            #bup limited
    bup_as_1[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_limited", "1", sep = "_", i, ".rds")))
    
    bup_as_2[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_limited", "2", sep = "_", i, ".rds")))
    
    bup_as_3[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result_limited", "3", sep = "_", i, ".rds")))
    ...
    # bup all
    bup_1[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result", "1", sep = "_", i, ".rds")))

    bup_2[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result", "2", sep = "_", i, ".rds")))
    
    bup_3[[i]] <- readRDS(here::here(paste0("./data/final_0724/bup/","result", "3", sep = "_", i, ".rds")))
...
met_cont_total <- met_cont_lim |>
    ...
    mutate(type = factor(type, levels = c("Adjusted by age & sex", "Adjusted by expanded set")))
...
comb_binomial_total <- comb_binomial_lim |>
...
comb_binomial_pair <-comb_binomial_as |> mutate(type = "Adjusted by age & sex") |>
