...
unadjust_bup_12 <- unadjusted_diff(data_bup_long_1, data_bup_long_2)

unadjust_bup_13 <- unadjusted_diff(data_bup_long_1, data_bup_long_3)

unadjust_bup_23 <- unadjusted_diff(data_bup_long_2, data_bup_long_3)

bup_unadj_b <- ggplot(unadjust_bup_12, aes(x = time, y = effect_est)) +
    geom_point() + 
  geom_line() +   # Connect means with lines
  geom_ribbon(aes(ymin = ci_lwr, ymax = ci_upr), alpha = 0.3) + 
  labs(title = "Difference in Mean Buprenorphine Dose (W v. B, Unadjusted)",
       x = "Week",
...
bup_unadj_c <- ggplot(unadjust_bup_13, aes(x = time, y = effect_est)) +
  ...
  geom_line() +   # Connect means with lines
  geom_ribbon(aes(ymin = ci_lwr, ymax = ci_upr), alpha = 0.3) + 
  labs(title = "Difference in Mean Buprenorphine Dose (W v. H, Unadjusted)",
       x = "Week",
       y = "Mean Dose Difference") +
    scale_x_continuous(breaks = seq(1, 4, by = 1)) +
  theme_minimal() +
...
bup_unadj_d <- ggplot(unadjust_bup_23, aes(x = time, y = effect_est)) +
  ...
  geom_line() +   # Connect means with lines
  geom_ribbon(aes(ymin = ci_lwr, ymax = ci_upr), alpha = 0.3) + 
  labs(title = "Difference in Mean Buprenorphine Dose (B v. H, Unadjusted)",
       x = "Week",
       y = "Mean Dose Difference") +
    scale_x_continuous(breaks = seq(1, 4, by = 1)) +
  theme_minimal() +
...
bup_as_figure <- ggarrange(bup_cont, bup_unadj_b, bup_unadj_c, bup_unadj_d + font("x.text", size = 0.5),
...
unadjust_met_12 <- unadjusted_diff(data_met_long_1, data_met_long_2)

unadjust_met_13 <- unadjusted_diff(data_met_long_1, data_met_long_3)

unadjust_met_23 <- unadjusted_diff(data_met_long_2, data_met_long_3)

met_unadj_b <- ggplot(unadjust_met_12, aes(x = time, y = effect_est)) +
    geom_point() + 
  geom_line() +   # Connect means with lines
  geom_ribbon(aes(ymin = ci_lwr, ymax = ci_upr), alpha = 0.3) + 
  labs(title = "Difference in Mean Methadone Dose (W v. B, Unadjusted)",
       x = "Week",
       y = "Mean Dose Difference") +
    scale_x_continuous(breaks = seq(1, 4, by = 1)) +
  theme_minimal() +
...
met_unadj_c <- ggplot(unadjust_met_13, aes(x = time, y = effect_est)) +
  ...
  geom_line() +   # Connect means with lines
  geom_ribbon(aes(ymin = ci_lwr, ymax = ci_upr), alpha = 0.3) + 
  labs(title = "Difference in Mean Methadone Dose (W v. H, Unadjusted)",
       x = "Week",
       y = "Mean Dose Difference") +
    scale_x_continuous(breaks = seq(1, 4, by = 1)) +
  theme_minimal() +
...
met_unadj_d <- ggplot(unadjust_met_23, aes(x = time, y = effect_est)) +
  ...
  geom_line() +   # Connect means with lines
  geom_ribbon(aes(ymin = ci_lwr, ymax = ci_upr), alpha = 0.3) + 
  labs(title = "Difference in Mean Methadone Dose (B v. H, Unadjusted)",
       x = "Week",
       y = "Mean Dose Difference") +
    scale_x_continuous(breaks = seq(1, 4, by = 1)) +
  theme_minimal() +
...
met_unadj_figure <- ggarrange(met_cont, met_unadj_b, met_unadj_c, met_unadj_d + font("x.text", size = 0.5),
                    ncol = 2, nrow = 2, labels = c("A", "B", "C", "D"), vjust= 1.75, 
                  font.label=list(color="black",size=10, family = "Times New Roman"))
met_unadj_figure
```
