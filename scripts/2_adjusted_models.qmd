...
baseline_complete <- c("sex", "age", "site", "edu", "edu_missing", "mar", "mar_missing",
                       "hwithdraw", "hwithdraw_missing", "hcows", "hcows_missing",
...
data_bup <- data_bup |>
  mutate(sex = ifelse(sex == "female", "1", "0"),
      ...
      hwithdraw_missing = ifelse(is.na(hwithdraw), 1, 0),
      hwithdraw = as.factor(case_when(is.na(hwithdraw) ~ "2",
                                      TRUE ~ hwithdraw)),
      hcows_missing = ifelse(is.na(hcows), 1, 0),
      hcows = ifelse(is.na(hcows), mean(hcows, na.rm = TRUE), hcows),
  ...
  mutate_at(vars(all_of(baseline_complete), -age, -site, -edu, -mar, -hcows, -hwithdraw), funs(factor(., ordered = FALSE, levels = c("0", "1")))) |>
...
B_bup <- c("sex", "age", "edu", "edu_missing", "mar", "mar_missing",
                    "hcows",
                       "falcohol", "falcohol_missing", "fdrug", "fdrug_missing",
                       "alcdisorder", "alcdisorder_missing", "cocdisorder", "cocdisorder_missing",
...
B_met <- c("sex", "age", "edu", "edu_missing", "mar", "mar_missing",
                    "hcows",
                       "falcohol", "falcohol_missing", "fdrug", "fdrug_missing",
                       "alcdisorder", "alcdisorder_missing", "cocdisorder", "cocdisorder_missing",
       "hasBrainDamage", "hasEpilepsy",
