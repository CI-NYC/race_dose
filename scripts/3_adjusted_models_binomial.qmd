...
for(j in 1:3) # looping over race
{
    ...
    for (i in 3:4) # looping over weeks (3-4 for now)
    {
        ...
        progressr::with_progress(tmle_list_cs_comb[[i]] <- lmtp_tmle(
            ...
            shift = func_list[[j]], 
            outcome_type = "binomial", 
            learners_outcome = lrnrs_out_bup,
            learners_trt = lrnrs_trt_bup,
            folds = 10,
            .SL_folds = 10,
            mtp = FALSE)) 
        ...
        # saving results
        saveRDS(tmle_list_cs_comb[[i]], here::here(paste0("./data/102623/comb_binomial/", "result_comb", j, sep = "_", i, ".rds")))
        saveRDS(tmle_list_cs_met_limited[[i]], here::here(paste0("./data/102623/comb_binomial/", "result_comb_limited", j, sep = "_", i, ".rds")))
    }
