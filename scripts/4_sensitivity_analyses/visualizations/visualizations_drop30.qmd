...
for (i in 4:4) {
    ...
    #bup limited
    bup_as_1[[1]] <- readRDS(here::here(paste0("./data/trial_indicator_drop30/bup/","result_newcensor_limited", "1", sep = "_", i, ".rds")))
    
    bup_as_2[[1]] <- readRDS(here::here(paste0("./data/trial_indicator_drop30/bup/","result_newcensor_limited", "2", sep = "_", i, ".rds")))
    
    bup_as_3[[1]] <- readRDS(here::here(paste0("./data/trial_indicator_drop30/bup/","result_newcensor_limited", "3", sep = "_", i, ".rds")))
}
...
```{r}
saveRDS(bup_cont_total, here::here("data/table_data/appendix/bup_cont_total_trial_indicator_drop30.rds"))
saveRDS(bup_cont_pair, here::here("data/table_data/appendix/bup_cont_pair_trial_indicator_drop30.rds"))
```
