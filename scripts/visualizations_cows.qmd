...
```{r}
met_result_newcensors_lim <- data.frame(week = integer(0), race = numeric(0), project = numeric(0),
                                        theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))

bup_result_newcensors_lim <- data.frame(week = integer(0), race = numeric(0), project = numeric(0),
                                        theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))

comb_binomial_lim <- data.frame(week = integer(0), race = numeric(0), project = numeric(0),
                                theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))
...
for (j in 1:3)
{
met_result_newcensors_all_temp <- data.frame(week = numeric(0), race = numeric(0), project = numeric(0),
                                             theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))

met_result_newcensors_lim_temp <- data.frame(week = numeric(0), race = numeric(0), project = numeric(0),
                                             theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))
...
for (i in 4:4) {
  ...
  met_result_newcensors_lim_temp[[i, "project"]] <- z
...
for (j in 1:3)
{
    comb_binomial_lim_temp <- data.frame(week = numeric(0), race = numeric(0), project = numeric(0),
                                         theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))
    
    comb_binomial_all_temp <- data.frame(week = numeric(0), race = numeric(0), project = numeric(0),
                                         theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))
...
for (i in 4:4) 
{
    ...
    comb_binomial_lim_temp[[i, "project"]] <- z
...
for (z in 1:1)
{
    for (i in 4:4) {
        ...
        if(i >= 3){
            ...
            #bup limited
            bup_as_1_high[[1]] <- readRDS(here::here(paste0("./data/cows/bup/","result_newcensor_limited", "1", sep = "_", i, 
                                                       sep = "_", z, ".rds")))
            
            bup_as_2_high[[1]] <- readRDS(here::here(paste0("./data/cows/bup/","result_newcensor_limited", "2", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            bup_as_3_high[[1]] <- readRDS(here::here(paste0("./data/cows/bup/","result_newcensor_limited", "3", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            #met limited
            met_as_1_high[[1]] <- readRDS(here::here(paste0("./data/cows/met/","result_newcensor_met_limited", "1", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            met_as_2_high[[1]] <- readRDS(here::here(paste0("./data/cows/met/","result_newcensor_met_limited", "2", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            met_as_3_high[[1]] <- readRDS(here::here(paste0("./data/cows/met/","result_newcensor_met_limited", "3", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            #comb binomial limited
            comb_binomial_as_1_high[[1]] <- readRDS(here::here(paste0("./data/cows/comb_binomial/","result_newcensor_comb_limited", "1", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_2_high[[1]] <- readRDS(here::here(paste0("./data/cows/comb_binomial/","result_newcensor_comb_limited", "2", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_3_high[[1]] <- readRDS(here::here(paste0("./data/cows/comb_binomial/","result_newcensor_comb_limited", "3", sep = "_", i, sep = "_", z, ".rds")))
        }
    }
...
for (z in 2:2)
{
    for (i in 4:4) {
        ...
        if(i >= 3){
            ...
            #bup limited
            bup_as_1_low[[1]] <- readRDS(here::here(paste0("./data/cows/bup/","result_newcensor_limited", "1", sep = "_", i, 
                                                       sep = "_", z, ".rds")))
            
            bup_as_2_low[[1]] <- readRDS(here::here(paste0("./data/cows/bup/","result_newcensor_limited", "2", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            bup_as_3_low[[1]] <- readRDS(here::here(paste0("./data/cows/bup/","result_newcensor_limited", "3", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            #met limited
            met_as_1_low[[1]] <- readRDS(here::here(paste0("./data/cows/met/","result_newcensor_met_limited", "1", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            met_as_2_low[[1]] <- readRDS(here::here(paste0("./data/cows/met/","result_newcensor_met_limited", "2", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            met_as_3_low[[1]] <- readRDS(here::here(paste0("./data/cows/met/","result_newcensor_met_limited", "3", sep = "_", i,
                                                       sep = "_", z, ".rds")))
            
            #comb binomial limited
            comb_binomial_as_1_low[[1]] <- readRDS(here::here(paste0("./data/cows/comb_binomial/","result_newcensor_comb_limited", "1", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_2_low[[1]] <- readRDS(here::here(paste0("./data/cows/comb_binomial/","result_newcensor_comb_limited", "2", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_3_low[[1]] <- readRDS(here::here(paste0("./data/cows/comb_binomial/","result_newcensor_comb_limited", "3", sep = "_", i, sep = "_", z, ".rds")))
        }
    }
...
theta_df <- met_result_newcensors_lim |>
    ...
    mutate(cows = ifelse(project == 1, "high", "low")) |>
