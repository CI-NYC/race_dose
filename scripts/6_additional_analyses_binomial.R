...
for(j in 1:3) # looping over race
{
    ...
    for (i in 3:4) # looping over weeks (3-4 for now)
    {
        ...
        if (i > 1)
        {
            B_comb <- list(trt = c("sex", "age", "hcows_bin","alcdisorder", 
                           ...
                           cens = c("sex", "age", "hcows_bin","alcdisorder", 
                                    ...
                                    "trt_ind", "project"), #indicator for bup/met
            ...
            B_comb_as <- list(trt = c("sex", "age", "project"),
                              cens = c("sex", "age", "hcows_bin","alcdisorder", 
                                       "alcdisorder_missing", "cocdisorder", "cocdisorder_missing",
                                       "hasBipolar","hasAnxPan",
                                       "hasMajorDep",
        ...
        # saving results
        saveRDS(tmle_list_cs_comb[[i]], here::here(paste0("./data/trial_indicator/comb_binomial/", "result_newcensor_comb", j, sep = "_", i, ".rds")))
        saveRDS(tmle_list_cs_comb_limited[[i]], here::here(paste0("./data/trial_indicator/comb_binomial/", "result_newcensor_comb_limited", j, sep = "_", i, ".rds")))
    }
