...
source(here::here("scripts/source/shift_functions.R"))

project_ids <- readRDS("~/Desktop/epi2023/oud_treatment_dosage/data/processed/project_ids.rds")
project_ids_comb <- readRDS("~/Desktop/epi2023/oud_treatment_dosage/data/processed/project_ids_comb.rds")
```
...
for (i in 1:4) {
    ...
    if (i > 2)
    {
  data_met <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met", j, sep = "_", i, ".rds")))
  ...
  data_met_lim <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met_limited", j, sep = "_", i, ".rds")))
  ...
  data_bup <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor", j, sep = "_", i, ".rds"))), id = project_ids)
  ...
  data_bup_lim <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor_limited", j, sep = "_", i, ".rds"))), id = project_ids)
  ...
  bup_result_newcensors_lim_temp[[i, "upper"]] <- data_bup_lim$high
    ...
    {
    data_met <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met", j, sep = "_", i, ".rds")))
  met_result_newcensors_all_temp[[i, "week"]] <- i
  met_result_newcensors_all_temp[[i, "race"]] <- j
  met_result_newcensors_all_temp[[i, "theta"]] <- data_met$theta
  met_result_newcensors_all_temp[[i, "se"]] <- data_met$standard_error
  ...
  data_met_lim <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met_limited", j, sep = "_", i, ".rds")))
  met_result_newcensors_lim_temp[[i, "week"]] <- i
  met_result_newcensors_lim_temp[[i, "race"]] <- j
  met_result_newcensors_lim_temp[[i, "theta"]] <- data_met_lim$theta
  met_result_newcensors_lim_temp[[i, "se"]] <- data_met_lim$standard_error
  ...
  data_bup <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result", j, sep = "_", i, ".rds"))), id = project_ids)
  bup_result_newcensors_all_temp[[i, "week"]] <- i
  bup_result_newcensors_all_temp[[i, "race"]] <- j
  bup_result_newcensors_all_temp[[i, "theta"]] <- data_bup$theta
  bup_result_newcensors_all_temp[[i, "se"]] <- data_bup$standard_error
  ...
  data_bup_lim <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_limited", j, sep = "_", i, ".rds"))), id = project_ids)
  bup_result_newcensors_lim_temp[[i, "week"]] <- i
  bup_result_newcensors_lim_temp[[i, "race"]] <- j
  bup_result_newcensors_lim_temp[[i, "theta"]] <- data_bup_lim$theta
  bup_result_newcensors_lim_temp[[i, "se"]] <- data_bup_lim$standard_error
...
for (i in 3:4) 
{
    data_comb_binomial_lim <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb_limited", j, sep = "_", i, ".rds"))), id = project_ids_comb)
    ...
    data_comb_binomial_all <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb", j, sep = "_", i, ".rds"))), id = project_ids_comb)
...
for (i in 1:4) {
    ...
    #bup limited
    bup_as_1[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor_limited", "1", sep = "_", i, ".rds"))), id = project_ids)
    
    bup_as_2[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor_limited", "2", sep = "_", i, ".rds"))), id = project_ids)
    
    bup_as_3[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor_limited", "3", sep = "_", i, ".rds"))), id = project_ids)

    #met limited
    met_as_1[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met_limited", "1", sep = "_", i, ".rds")))
    
    met_as_2[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met_limited", "2", sep = "_", i, ".rds")))

    met_as_3[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met_limited", "3", sep = "_", i, ".rds")))
    
    # bup all
    bup_1[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor", "1", sep = "_", i, ".rds"))), id = project_ids)

    bup_2[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor", "2", sep = "_", i, ".rds"))), id = project_ids)
    
    bup_3[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_newcensor", "3", sep = "_", i, ".rds"))), id = project_ids)

    # met all
    met_1[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met", "1", sep = "_", i, ".rds")))
    met_2[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met", "2", sep = "_", i, ".rds")))
    met_3[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_newcensor_met", "3", sep = "_", i, ".rds")))
    
    # binomial
    
    #comb binomial limited
    comb_binomial_as_1[[i-2]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb_limited", "1", sep = "_", i, ".rds"))), id = project_ids_comb)
    
    comb_binomial_as_2[[i-2]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb_limited", "2", sep = "_", i, ".rds"))), id = project_ids_comb)
    
    comb_binomial_as_3[[i-2]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb_limited", "3", sep = "_", i, ".rds"))), id = project_ids_comb)
    
    # comb binomial all
    comb_binomial_1[[i-2]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb", "1", sep = "_", i, ".rds"))), id = project_ids_comb)
    comb_binomial_2[[i-2]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb", "2", sep = "_", i, ".rds"))), id = project_ids_comb)
    comb_binomial_3[[i-2]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/comb_binomial/","result_newcensor_comb", "3", sep = "_", i, ".rds"))), id = project_ids_comb)
    } else
    {
            #bup limited
    bup_as_1[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_limited", "1", sep = "_", i, ".rds"))), id = project_ids)
    
    bup_as_2[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_limited", "2", sep = "_", i, ".rds"))), id = project_ids)
    
    bup_as_3[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result_limited", "3", sep = "_", i, ".rds"))), id = project_ids)

    #met limited
    met_as_1[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met_limited", "1", sep = "_", i, ".rds")))
    
    met_as_2[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met_limited", "2", sep = "_", i, ".rds")))

    met_as_3[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met_limited", "3", sep = "_", i, ".rds")))
    
    # bup all
    bup_1[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result", "1", sep = "_", i, ".rds"))), id = project_ids)

    bup_2[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result", "2", sep = "_", i, ".rds"))), id = project_ids)
    
    bup_3[[i]] <- recalc_var_with_id(readRDS(here::here(paste0("./data/trial_ID/bup/","result", "3", sep = "_", i, ".rds"))), id = project_ids)

    # met all
    met_1[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met", "1", sep = "_", i, ".rds")))
    met_2[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met", "2", sep = "_", i, ".rds")))
    met_3[[i]] <- readRDS(here::here(paste0("./data/trial_ID/met/","result_met", "3", sep = "_", i, ".rds")))
    }
}
...
ggsave(filename = here::here("figures/final_plot_new_variance.png"),
       plot = final_plot,
       width = 15, height = 20)
```
...
ggsave(filename = here::here("figures/appendix_plot_new_variance.png"),
       plot = appendix_plot,
       width = 15, height = 20)
```
