...
for(j in 1:3) # looping over race
{
    ...
    for (i in 3:4) # looping over weeks (3-4 for now)
    {
        ...
        # saving results
        saveRDS(tmle_list_cs[[i]], here::here(paste0("./data/trial_indicator_drop30/","result_newcensor", j, sep = "_", i, ".rds")))
...
for(j in 1:3) # looping over race
{
    ...
    for (i in 1:2) # looping over weeks (1-2)
    {
        ...
        # saving results
        saveRDS(tmle_list_cs[[i]], here::here(paste0("./data/trial_indicator_drop30/","result", j, sep = "_", i, ".rds")))
        saveRDS(tmle_list_cs_limited[[i]], here::here(paste0("./data/trial_indicator_drop30/","result_limited", j, sep = "_", i, ".rds")))
    }
