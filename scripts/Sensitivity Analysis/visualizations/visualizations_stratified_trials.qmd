...
comb_binomial_lim <- data.frame(week = integer(0), race = numeric(0), trial = numeric(0),
                                theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))
...
for (j in 1:3)
{
    comb_binomial_lim_temp <- data.frame(week = numeric(0), race = numeric(0), trial = numeric(0),
                                         theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))
    
    comb_binomial_all_temp <- data.frame(week = numeric(0), race = numeric(0), trial = numeric(0),
                                         theta = numeric(0), se = numeric(0), lower = numeric(0), upper = numeric(0))

    
for (i in 4:4) 
{
    data_comb_binomial_lim <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", j, sep = "_", i, sep = "_", z, ".rds")))
    comb_binomial_lim_temp[[1, "week"]] <- i
    comb_binomial_lim_temp[[1, "race"]] <- j
    comb_binomial_lim_temp[[1, "trial"]] <- z
...
comb_binomial_as_1_trial_27 <- list()
comb_binomial_as_2_trial_27 <- list()
comb_binomial_as_3_trial_27 <- list()
...
for (z in 1:1)
{
    for (i in 4:4) {
          ...
          if(i >= 3){  
            ...
            comb_binomial_as_1_trial_27[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "1", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_2_trial_27[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "2", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_3_trial_27[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "3", sep = "_", i, sep = "_", z, ".rds")))
        } 
    }
...
comb_binomial_as_12_contrast_trial_27 <- mapply(lmtp_contrast_simple, X = comb_binomial_as_2_trial_27, Y = comb_binomial_as_1_trial_27)

comb_binomial_as_12_df_trial_27 <- as.data.frame(comb_binomial_as_12_contrast_trial_27[,1]$val) |>
    mutate(time = 4) 

comb_binomial_as_13_contrast_trial_27 <- mapply(lmtp_contrast_simple, X = comb_binomial_as_3_trial_27, Y = comb_binomial_as_1_trial_27)

comb_binomial_as_13_df_trial_27 <- as.data.frame(comb_binomial_as_13_contrast_trial_27[,1]$val) |>
    mutate(time = 4)
...
comb_binomial_as_1_trial_30 <- list()
comb_binomial_as_2_trial_30 <- list()
comb_binomial_as_3_trial_30 <- list()
...
for (z in 2:2)
{
    for (i in 4:4) {
        ...
        if(i >= 3){
            ...
            #comb binomial limited
            comb_binomial_as_1_trial_30[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "1", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_2_trial_30[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "2", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_3_trial_30[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "3", sep = "_", i, sep = "_", z, ".rds")))
        } 
    }
...
comb_binomial_as_12_contrast_trial_30 <- mapply(lmtp_contrast_simple, X = comb_binomial_as_2_trial_30, Y = comb_binomial_as_1_trial_30)

comb_binomial_as_12_df_trial_30 <- as.data.frame(comb_binomial_as_12_contrast_trial_30[,1]$val) |>
    mutate(time = 4)

comb_binomial_as_13_contrast_trial_30 <- mapply(lmtp_contrast_simple, X = comb_binomial_as_3_trial_30, Y = comb_binomial_as_1_trial_30)

comb_binomial_as_13_df_trial_30 <- as.data.frame(comb_binomial_as_13_contrast_trial_30[,1]$val) |>
    mutate(time = 4)
...
comb_binomial_as_1_trial_51 <- list()
comb_binomial_as_2_trial_51 <- list()
comb_binomial_as_3_trial_51 <- list()
...
for (z in 3:3)
{
    for (i in 4:4) {
        ...
        if(i >= 3){
            ...
            #comb binomial limited
            comb_binomial_as_1_trial_51[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "1", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_2_trial_51[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "2", sep = "_", i, sep = "_", z, ".rds")))
            
            comb_binomial_as_3_trial_51[[1]] <- readRDS(here::here(paste0("./data/trial_stratify/comb_binomial/","result_newcensor_limited", "3", sep = "_", i, sep = "_", z, ".rds")))
        } 
    }
...
comb_binomial_as_12_contrast_trial_51 <- mapply(lmtp_contrast_simple, X = comb_binomial_as_2_trial_51, Y = comb_binomial_as_1_trial_51)

comb_binomial_as_12_df_trial_51 <- as.data.frame(comb_binomial_as_12_contrast_trial_51[,1]$val) |>
    mutate(time = 4)

comb_binomial_as_13_contrast_trial_51 <- mapply(lmtp_contrast_simple, X = comb_binomial_as_3_trial_51, Y = comb_binomial_as_1_trial_51)

comb_binomial_as_13_df_trial_51 <- as.data.frame(comb_binomial_as_13_contrast_trial_51[,1]$val) |>
    mutate(time = 4)
...
comb_as_12_df <- comb_binomial_as_12_df_trial_27 |>
    mutate(trial = "trial_27")|>
    merge(comb_binomial_as_12_df_trial_30 |>
    mutate(trial = "trial_30"), all = TRUE) |>
    merge(comb_binomial_as_12_df_trial_51 |>
    mutate(trial = "trial_51"), all = TRUE)

comb_as_13_df <- comb_binomial_as_13_df_trial_27 |>
    mutate(trial = "trial_27")|>
    merge(comb_binomial_as_13_df_trial_30 |>
    mutate(trial = "trial_30"), all = TRUE) |>
    merge(comb_binomial_as_13_df_trial_51 |>
    mutate(trial = "trial_51"), all = TRUE)
```
...
comb_theta_plot <- ggplot(comb_binomial_total_temp, aes(x = trial, y = theta, group = race, color = race, fill = race, shape = race)) +
    geom_point(position = position_dodge(width = 0.5)) +
    geom_errorbar(aes(ymin = lower, ymax = upper), width = 0.25, position = position_dodge(width = 0.5)) +
    labs(title = "",
         x = "trial Level",
         y = "Probability of Receiving a trial_27er Dose") +
    #scale_x_continuous(breaks = seq(1, 4, by = 1)) +
    scale_color_manual(values = custom_colors) + 
    scale_shape_manual(values = c(1, 0, 8)) +
    scale_fill_manual(values = custom_colors) +  
...
comb_diff_plot <- ggplot(comb_binomial_pair_temp, aes(x = trial, y = theta, group = race, color = race, fill = race, shape = race)) +
    geom_point(position = position_dodge(width = 0.5)) +
    geom_errorbar(aes(ymin = conf.trial_30, ymax = conf.trial_27), width = 0.25, position = position_dodge(width = 0.5)) +
    labs(title = "",
         x = "trial Level",
         y = "Difference in Probability of Receiving a trial_27er Dose") +
    geom_hline(yintercept = 0, linetype = "dotted", color = "black") +
    #scale_x_continuous(breaks = seq(1, 4, by = 1)) +
    scale_color_manual(values = c("#1f78b4", "darkseagreen4")) + 
    scale_shape_manual(values = c(1, 0, 8)) +
...
final_plot <- (final_plot_cont_bup | final_plot_comb) +
    plot_layout(ncol = 3, tag_level = 'new') & 
    theme(plot.tag = element_text(size = 24),
          panel.border = element_rect(colour = "black", fill=NA))

ggsave(filename = here::here("figures/trial_stratify_stratify_as.png"),
       plot = final_plot,
       width = 15, height = 20)
```
